	...
	if($edit)
	{
		...
		<div>
			...
			<form action="" method="post">
				...
				<tbody>
					<tr>
						<th scope="row" valign="top"><label><?php esc_html_e('ID:', 'pmpro-affiliates'); ?></label></th>
					...
					<tr>
						<th scope="row" valign="top"><label for="code"><?php esc_html_e('Code:', 'pmpro-affiliates'); ?></label></th>
						<td>
							<input id="code" name="code" type="text" size="20" value="<?php if(!empty($code)) echo esc_attr($code);?>" />
							<small><?php echo esc_html( sprintf( esc_html__('Value added to the site URL to designate the %s link. (e.g. "&pa=CODE" or "?pa=CODE")', 'pmpro-affiliates' ), $pmpro_affiliates_singular_name ) ); ?></small>
						</td>
					</tr>
					...
					<tr>
						<th scope="row" valign="top"><label for="affiliateuser"><?php echo esc_html( sprintf( esc_html__( '%s User:',  'pmpro-affiliates' ), ucwords($pmpro_affiliates_singular_name) ) ); ?></label></th>
						<td>
							<input id="affiliateuser" name="affiliateuser" type="text" size="20" value="<?php if(!empty($affiliateuser)) echo esc_attr($affiliateuser);?>" />
							<small><?php echo esc_html( sprintf( esc_html__('The username of a WordPress user in your site who should have access to %s reports.', 'pmpro-affiliates'), $pmpro_affiliates_singular_name ) ); ?></small>
						</td>
					</tr>
					...
					<tr>
						<th scope="row" valign="top"><label for="trackingcode"><?php esc_html_e('Tracking Code:', 'pmpro-affiliates'); ?></label></th>
						<td>
							...
							<br /><small><?php echo esc_html( sprintf( esc_html__("(Optional) If you are tracking this %s through another system, you can add HTML/JS code here to run on the confirmation page after checkout. Variables:", 'pmpro-affiliates' ), $pmpro_affiliates_singular_name ) ); ?> !!ORDER_ID!!, !!ORDER_AMOUNT!!, !!LEVEL_NAME!!</small>
						</td>
					</tr>
					...
					<tr>
						<th scope="row" valign="top"><label for="enabled"><?php esc_html_e('Enabled:', 'pmpro-affiliates'); ?></label></th>
						<td id="enabled">
					...
					<tr>
						...
						<td>
							<?php echo esc_html( pmpro_formatPrice( $total_commissions ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<?php echo esc_html( pmpro_formatPrice( $paid_commissions ) ); ?>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<?php 
							echo esc_html( pmpro_formatPrice( $unpaid_commissions ) ); 
						...
						<tr>
							<td class="affiliate_code column-affiliate_code has-row-actions">
								...
								<div class="row-actions">
									<span class="id">
										<?php echo esc_html( sprintf( esc_html__( 'ID: %s', 'pmpro-affiliates' ), $affiliate->id ) ); ?>
									</span>
									<span class="report">
							...
							<td>
								<?php
								echo esc_html( pmpro_formatPrice( $earnings * $affiliate->commissionrate ) );
								?>
							</td>
							<td>
								<?php echo esc_html( pmpro_formatPrice( $earnings ) ); ?>
							</td>
							<?php
								/**
